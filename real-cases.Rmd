...
Let's first check what's the reported case fatality ratio for different regions in the world, those that have at least 10000 cases 
(see table 1, below). Max and mininum CFR are computed over the rows in which there were already 1000 cases.
