...
world.data <- world.data %>% group_by(Province.State,Country.Region) %>% mutate( New.Cases= Cases-lag(Cases, default=0))
world.data %>% group_by(Province.State,Country.Region) %>% mutate( New.Deaths = Cases-lag(Deaths, default=0))
