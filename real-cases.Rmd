...
author: "J. J. Merelo, Víctor Rivas-Santos"
date: "April 4th, 2020"
output:
...
```{r ccfko,echo=FALSE,message=FALSE, warning=FALSE, fig.cap="Raw cross-correlation between daily new cases and new deaths"}
...
```{r ccfrolling,echo=FALSE,message=FALSE,fig.cap="Cross-correlation for 3-days rolling sum"}
