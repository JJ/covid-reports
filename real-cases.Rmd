...
```{r cfrevol,echo=FALSE,message=FALSE,warning=FALSE}
...
ggplot(world.data.filtered, aes(x=Date,y=CFR,color=Country.Region,group=Country.Region))+geom_line()+theme_tufte()+theme(legend.position = "bottom")
```
